...
execute store result score @s[tag=swPool_z] swPool_var00 run data get entity @s Pos[2] 10000
execute store result score @s[tag=swPool_z] swPool_var01 run data get entity @s Pos[0] 10000
summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_red","swPool_new"],NoGravity:1,Small:1,Invisible:1}
scoreboard players set @s swPool_var05 2
scoreboard players operation @s swPool_var02 = @s swPool_dl
scoreboard players operation @s swPool_var02 /= @s swPool_var05
...
execute store result score @s[tag=swPool_z] swPool_var00 run data get entity @s Pos[2] 10000
execute store result score @s[tag=swPool_z] swPool_var01 run data get entity @s Pos[0] 10000
execute if entity @s[scores={swPool_dl=43750..}] run summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_red","swPool_new"],NoGravity:1,Small:1,Invisible:1}
scoreboard players set @s swPool_var05 2
scoreboard players operation @s swPool_var02 = @s swPool_dl
scoreboard players operation @s swPool_var02 /= @s swPool_var05
scoreboard players add @s swPool_var02 2600
...
execute store result score @s[tag=swPool_z] swPool_var00 run data get entity @s Pos[2] 10000
execute store result score @s[tag=swPool_z] swPool_var01 run data get entity @s Pos[0] 10000
execute if entity @s[scores={swPool_dl=53750..}] run summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_red","swPool_new"],NoGravity:1,Small:1,Invisible:1}
scoreboard players set @s swPool_var05 2
scoreboard players operation @s swPool_var02 = @s swPool_dl
scoreboard players operation @s swPool_var02 /= @s swPool_var05
scoreboard players add @s swPool_var02 2600
...
scoreboard players set @s swPool_time 0
