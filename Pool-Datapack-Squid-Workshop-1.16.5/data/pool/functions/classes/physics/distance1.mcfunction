...
execute unless entity @e[tag=swPool_d2,distance=..1,limit=1] run scoreboard players set @s swPool_dist 99999999
execute if entity @e[tag=swPool_d2,distance=..1,limit=1] run scoreboard players operation @s swPool_dist = @s swPool_var00
